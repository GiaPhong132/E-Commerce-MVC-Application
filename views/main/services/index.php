...
<head>
    ...
    <!-- <link rel="stylesheet" href="e_commerce/public/assets"> -->
                ...
                <nav class="header__navbar hide-on-mobile-tablet">
                    ...
                    <ul class="header__nav-list">
                        ...
                        <li class="header__nav-item header__nav-item--bold header__nav-item--separate">
                            <a href="./Signin.html" class="header__nav-item-link">Đăng ký</a>
                        </li>
                        <li class="header__nav-item header__nav-item--bold">
                            <a href="./Login.html" class="header__nav-item-link">Đăng nhập</a>
                        </li>
